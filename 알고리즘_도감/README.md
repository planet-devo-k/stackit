...
- 알고리즘 도감(도서, 앱) by 이시다 모리테루, 미야자키 쇼이치
...
- 진행방식:
  - 매주 정해진 분량 학습 후, 정리한 내용 발표, 질의응답 및 토론
  - 발표자는 매주 랜덤하게 정합니다.
  - 보증금 제도로 운영합니다.
...
- 매주 **일요일 오후 8시**까지 `main` 브랜치로 PR을 제출합니다.
...
- 정산
  - 정산은 세션 마지막 날 진행합니다.
  - 패널티 금액과 모임통장에서 발생한 이자는 참여자 수로 나누어 분배합니다.
